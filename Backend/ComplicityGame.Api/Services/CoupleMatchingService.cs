...
using ComplicityGame.Core.Models; // entity classes (User, Couple, CoupleUser)
...
namespace ComplicityGame.Api.Services
{
    ...
    {
    private readonly ComplicityGame.Api.Models.GameDbContext _context;
        private readonly IEventPublisher _eventPublisher;
        private readonly IUserPresenceService _presenceService;
        private readonly ILogger<CoupleMatchingService> _logger;

        public CoupleMatchingService(
            ComplicityGame.Api.Models.GameDbContext context,
